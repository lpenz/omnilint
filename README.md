...
|------------|-------------------------------|--------------------------------------|
| Python     | `.py`, `#!/usr/bin/python3`, `#!/usr/bin/env python3`, ... | [flake8](https://flake8.pycqa.org/), [mypy](https://mypy-lang.org/), [pylint](https://pylint.readthedocs.io/) and [ruff](https://docs.astral.sh/ruff/) |
...
- `flake8`, `mypy`, `pylint` and `ruff` for Python
